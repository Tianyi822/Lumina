...
export function registerKnowledgeHandlers(): void {
  ...
  // 创建知识库
  ipcMain.handle('knowledge:create', async (_event, data: Omit<KnowledgeBase, 'id' | 'createdAt' | 'updatedAt'>) => {
    try {
  ...
  // 更新知识库
  ipcMain.handle('knowledge:update', async (_event, id: string, updates: Partial<Omit<KnowledgeBase, 'id' | 'createdAt'>>) => {
    try {
