...
<template>
  <div :class="styles['paper-markdown-view']">
    <div v-if="textSearch.isOpen.value" :class="styles['paper-markdown-view__search-bar']">
      <input
        ref="searchInputRef"
        v-model="textSearch.query.value"
        type="text"
        :class="styles['paper-markdown-view__search-input']"
        placeholder="搜索..."
        @keydown="handleSearchInputKeydown"
      />
      <span v-if="textSearch.hasMatches.value" :class="styles['paper-markdown-view__search-count']">
        {{ textSearch.currentIndex.value + 1 }} / {{ textSearch.matchCount.value }}
      </span>
      <span
        v-else-if="textSearch.query.value.trim()"
        :class="styles['paper-markdown-view__search-count']"
      >
        无结果
      </span>
      <button
        :class="styles['paper-markdown-view__search-btn']"
        type="button"
    ...
    <div
      ...
      :class="styles['paper-markdown-view__scroll']"
    ...
    >
      <div v-if="loading" :class="styles['paper-markdown-view__loading']">
        <p>正在加载内容...</p>
      </div>

      <div v-else-if="engine.parseError.value" :class="styles['paper-markdown-view__error']">
        <p>{{ engine.parseError.value }}</p>
      </div>

      <div v-else-if="!hasContent" :class="styles['paper-markdown-view__empty']">
        <p>暂无内容</p>
      </div>

      <article v-else :class="styles['paper-markdown-view__content']" :style="contentZoomStyle">
